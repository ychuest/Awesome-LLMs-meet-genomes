...
| Time | Title                                                        |  Venue  |                            Paper                             |                             Code                             |
| ---- | ------------------------------------------------------------ | :-----: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| 2025.05 | **DNAZEN: Enhanced Gene Sequence Representations via Mixed Granularities of Coding Units** |    	BioRxiv   | [link](https://arxiv.org/abs/2505.02206)  |                             [link](https://github.com/oomics/dnazen)                               |
